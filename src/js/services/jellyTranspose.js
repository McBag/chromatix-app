...
const transposeArtistData = (artist, libraryId, serverBaseUrl, accessToken, baseUrl = 'artists') => {
  return {
    ...
    link: '/libraries/' + libraryId + '/' + baseUrl + '/' + artist.Id,
...
const transposeAlbumData = (album, libraryId, serverBaseUrl, accessToken) => {
  ...
  return {
    ...
    link: '/libraries/' + libraryId + '/albums/' + album.Id,
...
const transposePlaylistData = (playlist, libraryId, serverBaseUrl, accessToken) => {
  return {
    ...
    link: '/libraries/' + libraryId + '/playlists/' + playlist.Id,
...
const transposeGenreData = (primaryKey, genre, libraryId) => {
  ...
  return {
    ...
    link: '/libraries/' + libraryId + '/' + primaryKey + '-genres/' + genreId,
  };
};
...
const transposeTagData = (primaryKey, tag, libraryId) => {
  ...
  return {
    ...
    tagId: tagId,
    title: tag.replace(/\//g, ' & '),
    link: '/libraries/' + libraryId + '/' + primaryKey + '-tags/' + tagId,
  };
};
...
const transposeTrackData = (track, libraryId, serverBaseUrl, accessToken) => {
  ...
  return {
    ...
    artist: artistName,
    artistId: artistId,
    artistLink: artistId ? '/libraries/' + libraryId + '/artists/' + artistId : null,
    album: track.Album,
  ...
  if (result?.Type) {
    if (result.Type === 'MusicArtist') {
      return {
        ...
        icon: 'PeopleIcon',
        title: result.Name,
        link: '/libraries/' + libraryId + '/artists/' + result.Id,
      ...
      return {
        ...
        icon: 'PlayCircleIcon',
        title: result.Name,
        link: '/libraries/' + libraryId + '/albums/' + result.Id,
        thumbSm: getThumb(result, serverBaseUrl, accessToken, thumbSizeSmall),
      };
      ...
      return {
        ...
        icon: 'PlaylistIcon',
        title: result.Name,
        link: '/libraries/' + libraryId + '/playlists/' + result.Id,
        thumbSm: getThumb(result, serverBaseUrl, accessToken, thumbSizeSmall),
      };
      ...
      return {
        ...
        title: result.Name,
        link: '/libraries/' + libraryId + '/albums/' + (result.ParentId || result.AlbumId),
        thumbSm: getThumb(result, serverBaseUrl, accessToken, thumbSizeSmall),
      };
    }
  }
